...
CREATE TABLE IF NOT EXISTS `brigadista` (
  ...
  KEY `ciudad` (`ciudad`),
  CONSTRAINT `FK_brigadista_departamentos` FOREIGN KEY (`departamento`) REFERENCES `departamentos` (`id_departamento`),
  CONSTRAINT `FK_brigadista_empresa` FOREIGN KEY (`empresa`) REFERENCES `empresa` (`idEmpresa`),
  CONSTRAINT `FK_brigadista_municipios` FOREIGN KEY (`ciudad`) REFERENCES `municipios` (`id_municipio`),
  CONSTRAINT `FK_brigadista_rol` FOREIGN KEY (`rol`) REFERENCES `rol` (`idRol`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla asobeecol.brigadista: ~5 rows (aproximadamente)
REPLACE INTO `brigadista` (`idBrigadista`, `nombreBrigadista`, `profesion`, `email`, `password`, `fechaInicio`, `rol`, `empresa`, `pais`, `departamento`, `ciudad`, `direccion`, `rh`, `celular`, `estado`, `cambioContrasenia`, `nuevaPassword`) VALUES
	(123, 'GG', 'Ingeniero', 'ggg@gmail.com', 'HolaMundo', '2023-04-20', 1, 3, 'Colombia', 76, 150, 'Carrera 42a 1542', 'B+', '3221456', 'Activo', 'NO', ''),
	(100200, 'Prueba', 'Tecnico en sistemas', 'prueba@gmail.com', '100200', '2023-09-14', 1, 4, 'Colombia', 52, 829, 'carrera 42a 15-42', 'A+', '321456987', 'Activo', NULL, NULL),
	(789654, 'Hola dos', 'ingeniero', 'holados@gmail.com', '789654', '2023-09-01', 1, 5, 'Colombia', 52, 829, 'carrera 42a 15-40', 'B+', '654123987', 'Activo', NULL, NULL),
	(1089848254, 'Juan Maya', 'Ingeniero de sistemas', 'juanmaya9902@gmail.com', '1089848254', '2011-04-19', 3, 1, 'Colombia', 52, 829, 'Crra 42a 15-42', 'B+', '3114211545', 'Activo', 'SI', NULL),
	(2147483647, 'Andres Salazar', 'Médico', 'andrees@gmail.com', '99021900202', '2023-02-19', 3, 1, 'Colombia', 52, 391, 'Crra 5 10-05', 'A+', '3234465896', 'Inactivo', 'NO', NULL);
...
-- Volcando datos para la tabla asobeecol.cursos: ~7 rows (aproximadamente)
REPLACE INTO `cursos` (`idCurso`, `brigadista`, `nombreCurso`, `fechaInicio`, `fechaFin`, `lugar`, `intensidadHoraria`) VALUES
	...
	(12, 2147483647, 'Alturas', '2023-09-01', '2023-09-14', 'Mariana', 8),
	(13, 1089848254, 'gg', '2023-09-01', '2023-09-06', 'Mariana', 16),
	(14, 100200, 'Altura', '2023-09-08', '2023-09-10', 'Udenar', 8),
	(15, 1089848254, 'Altura', '2023-09-09', '2023-09-10', 'UNIMAR', 8),
	(17, 100200, 'Hola mundo', '2023-09-01', '2023-09-02', 'Mari', 5),
	(18, 100200, 'Rescate en estructuras colapsadas', '2023-09-08', '2023-09-10', 'Unicentro', 5);

-- Volcando estructura para tabla asobeecol.departamentos
...
-- Volcando datos para la tabla asobeecol.departamentos: ~33 rows (aproximadamente)
REPLACE INTO `departamentos` (`id_departamento`, `departamento`) VALUES
	(5, 'ANTIOQUIA'),
	(8, 'ATLÁNTICO'),
	(11, 'BOGOTÁ, D.C.'),
	(13, 'BOLÍVAR'),
...
REPLACE INTO `donacion` (`idDonacion`, `tipo`, `genero`, `edad`, `cantidad`, `prioridad`, `fechaEntrega`, `descripcion`, `observaciones`, `brigadista`, `estado`, `fechaSalida`, `donado`, `almacen`, `tipoDonante`, `nombreDonante`, `documentoDonante`, `celularDonante`, `paisDonante`, `departamentoDonante`, `ciudadDonante`, `direccionDonante`, `comprobanteDinero`) VALUES
	(21, 'Alimentos', 'Masculino', '11-20 años', 12, 'Alta', '2023-05-02', 'Sardinas', 'latas', 1089848254, 'En Almacén', NULL, NULL, 'Unimar', 'Empresa', 'Unimar', 1, 748895632, 'Colombia', 'Nariño', 'Pasto', 'Centro', NULL),
...
-- Volcando datos para la tabla asobeecol.dotacion: ~7 rows (aproximadamente)
REPLACE INTO `dotacion` (`idDotacion`, `empresa`, `tipo`, `estado`, `observacion`) VALUES
	(5, 3, 'Radio', 'Maletin prueba', 'Disponible'),
	(6, 2, 'Martillo', 'Disponible', 'hola si'),
	(7, 4, 'Uniforme', 'Disponible', 'hola no'),
	(8, 5, 'Camilla', 'Disponible', 'cantidad mucha'),
	(9, 1, 'Camilla', 'Disponible', 'dfsdf'),
	(10, 2, 'Uniforme', 'Disponible', 'dfsd'),
	(11, 4, 'Camilla', 'Disponible', 'hola si');
...
-- Volcando estructura para tabla asobeecol.municipios
...
-- Volcando datos para la tabla asobeecol.municipios: ~1.100 rows (aproximadamente)
REPLACE INTO `municipios` (`id_municipio`, `municipio`, `estado`, `departamento_id`) VALUES
	(1, 'Abriaquí', 1, 5),
	(2, 'Acacías', 1, 50),
	(3, 'Acandí', 1, 27),
	(4, 'Acevedo', 1, 41),
...
CREATE TABLE `vbrigadista` (
	...
	`id_departamento` INT(2) NOT NULL,
	`departamento` VARCHAR(255) NOT NULL COLLATE 'utf8mb4_general_ci',
	`id_municipio` INT(6) NOT NULL,
	`municipio` VARCHAR(255) NOT NULL COLLATE 'utf8mb4_general_ci',
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vbrigadista` AS SELECT b.idBrigadista, b.nombreBrigadista,b.email, b.`password`,b.nuevaPassword,b.estado, b.fechaInicio,r.idRol,b.profesion, r.nombreRol,e.idEmpresa, e.nombreEmpresa, b.pais,d.id_departamento, d.departamento,m.id_municipio, m.municipio, b.direccion, b.rh, b.celular , 
b.cambioContrasenia FROM brigadista b, departamentos d, rol r, empresa e, municipios m WHERE b.rol = r.idRol AND  b.empresa = e.idEmpresa AND b.departamento=d.id_departamento AND m.id_municipio=b.ciudad ;
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vdotacion` AS SELECT d.idDotacion,e.idEmpresa, e.nombreEmpresa,d.tipo, d.estado, d.observacion FROM dotacion d, empresa e WHERE d.empresa = e.idEmpresa ;
